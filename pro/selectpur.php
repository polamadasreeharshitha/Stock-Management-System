...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Purchaser List</h1><br>
...
$sql = "SELECT cusid, stockid, purchase_quantity, year, month, day, item_amount FROM purchasers order by month,day";
