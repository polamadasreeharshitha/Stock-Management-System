...
<head>
  ...
  <meta charset="utf-8">
  <title>Update Customer Mobile Number Form</title>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Update Customer Mobile Number Form</h1>
  <div class="well mtl">
 <form method="post" action="updatecustomermobile.php">
 	<input type="hidden" name="purchaserform" value="addpurchaserform">
          <legend>Update Customer Mobile Number</legend>
        <div class="form-group">
            <label for="Customer_id">Customer_id</label>
 			<input type="number" class="form-control input-sm" name="customerid" placeholder="customer_id">
 		</div>
 		<div class="form-group">
            <label for="Customer_mobileno">Customer Mobile Number</label>
			<input type="tel" class="form-control input-sm" name="mobilenumber" placeholder="new contact number">
		</div>
...
mysqli_query($con,"update customers set cusphone=$mobilenumber where cusid=$customerid");
?>
</body>
</html>
