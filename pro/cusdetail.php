...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Customer Details Form</h1>
  <div class="well mtl">
 	...
 	<input type="hidden" name="purchaserform" value="purchaserform">
        ...
        <div class="form-group">
            <label for="Customer_id">Customer_id</label>
 			<input type="number" class="form-control input-sm" name="cusid" placeholder="cus_id">
 		</div>
 		<div class="form-group">
            <label for="Customer_Name">Customer_Name</label>
 			<input type="text" class="form-control input-sm" name="cusname" placeholder="cus_name">
 		</div>
...
$sql = "SELECT cusid, stockid, purchase_quantity, year, month, day, item_amount FROM purchasers where cusid=$cus_id";
