...
<head>
  ...
  <meta charset="utf-8">
  <title>Update Buyer Mobile Number Form</title>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Update Buyer Mobile Number Form</h1>
  <div class="well mtl">
 <form method="post" action="updatebuyermobile.php">
 	<input type="hidden" name="purchaserform" value="addpurchaserform">
          <legend>Update Buyer Mobile Number</legend>
        <div class="form-group">
            <label for="Buyer_id">Buyer_id</label>
 			<input type="number" class="form-control input-sm" name="buyerid" placeholder="buyer_id">
 		</div>
 		<div class="form-group">
            <label for="Buyer_mobileno">Buyer Mobile Number</label>
...
mysqli_query($con,"update buyers set contact_no=$mobilenumber where buyerid=$buyerid");
?>
</body>
</html>
