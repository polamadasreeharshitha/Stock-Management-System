...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Stock List</h1><br>
...
$sql = "SELECT stockid, stockqua, year, month, day, buyer_amount FROM stockdate order by month,day";
$result = $con->query($sql);
if ($result->num_rows > 0) {
    // output data of each row
    
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " . $row["stockid"] . " &nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " . $row["stockqua"] . " </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " . $row["day"] . "-" . $row["month"]. "-" . $row["year"] . " &nbsp&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " . $row['buyer_amount'] . "</td></tr>";
    }
} else {
    echo "0 results";
}
