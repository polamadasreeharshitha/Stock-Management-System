...
<head>
  ...
  <meta charset="utf-8">
  <title>Update Buyer Address Form</title>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Update Buyer Address Form</h1>
  <div class="well mtl">
 <form method="post" action="updatebuyeraddr.php">
 	<input type="hidden" name="purchaserform" value="addpurchaserform">
          <legend>Update Buyer Address</legend>
        <div class="form-group">
 		...
 		<div class="form-group">
			...
			<input type="text" class="form-control input-sm" name="buyeraddr" placeholder="new address">
		</div>
...
mysqli_query($con,"update buyers set buyeraddr='$buyeraddr' where buyerid=$buyerid");
?>
</body>
</html>
