...
<head>
  ...
  <meta charset="utf-8">
  <title>Update Customer Address Form</title>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-9">
<h1 id="hsub" itemprop="name">Update Customer Address Form</h1>
  <div class="well mtl">
 <form method="post" action="updatecusaddr.php">
 	<input type="hidden" name="purchaserform" value="addpurchaserform">
          <legend>Update Customer Address</legend>
        <div class="form-group">
            <label for="Customer_id">Customer_id</label>
 			<input type="number" class="form-control input-sm" name="cusid" placeholder="cusid">
 		</div>
 		<div class="form-group">
            <label for="Customer_address">Customer Address</label>
			<input type="text" class="form-control input-sm" name="cusaddr" placeholder="new address">
		</div>
...
mysqli_query($con,"update customers set cusaddr='$cusaddr' where cusid=$cusid");
?>
</body>
</html>
